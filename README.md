...
**Generar archivo JAR y ejecutar un proyecto**
  1. **Para VS CODE** Verificar que estén instaladas las extensiones **Kotlin language (by mathiasfeohlich)**, **kotlin formater (by esafirm)** y **Code Runner (by Jun Han)**
  ...
  3. **Ejecutar:** **java -jar Proyect.jar**
